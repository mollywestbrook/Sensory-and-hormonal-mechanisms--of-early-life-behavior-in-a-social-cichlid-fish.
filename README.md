...
Dlc-vs-sleap: old analysis about which ML program to use. Not used in this thesis, but archived within this folder due to overlap of data usage with the other folders in this project. 
Figure-7b: the R script used to generate Figure 7b in the thesis. 
